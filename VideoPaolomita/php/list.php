...
1		--><div class='name-article'>
		...
		<div class='box-image-article'>
                ...
                <div class='name-article'>
                        <h3><nobr><a class='art-link' href='index.php?page=list&sc=<?php echo"{$sc}";?>' alt='<?php echo "{$list[$i]->getNombre()} {$list[$i]->getApellido()}";?>'><?php echo "{$list[$i]->getNombre()} {$list[$i]->getApellido()}";?></a></nobr></h3> 
                </div>
                </div>
	</div>            
        <?php  } ?>
